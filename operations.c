 ...
 *
 * @stack: there pointer to the doubly linked list
 * @line_number: line where there is an inaccuracy
 * @n: op_code
 *
 * Return: void
*/
 ...
 *
 * @line_number: will not be used , we use impute not void
 * @stack: there pointer to pointer to the head of the doubly linked list
 *
 * Return: void
*/
 ...
 * op_nop - do nothing
 *
 * @stack: there pointer to pointer to the doubly linked list
 * @line_number: there number of lines in the file
 *
 * Return: void
 */
 ...
 * @line_number: there number of lines
 *
 * Return: void
*/
 ...
 * @stack: there pointer to the pointer to the head
 *
 * Return: void
 */
